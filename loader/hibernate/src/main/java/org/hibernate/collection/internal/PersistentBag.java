...
import afluentes.core.impl.SynchronousEvaluator0;
 ...
 * @author Gavin King
 */
public class PersistentBag extends AbstractPersistentCollection implements List, IEvaluationHolder<PersistentBag> {
	...
	// TODO Afluentes
	private IEvaluation<PersistentBag> evaluation = new SynchronousEvaluator0<>(new ISynchronousFunction0<PersistentBag>() {
		@Override
		public PersistentBag y() {
			initialize(true);
			return PersistentBag.this;
		}
	}).y();

	@Override
	public IEvaluation<PersistentBag> getEvaluation() {
		return evaluation;
	}
}